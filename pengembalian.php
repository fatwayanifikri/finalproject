...
<div class="row">
<div class="grid_12">
<h1><a href="#">Pengembalian Barang <br> Sarana dan Prasarana </a></h1>
by Fatwa's
</div>
</div>
</div>
...
<li><font size="3"><a href="pengembalian.php">Pengembalian </a></li></font>
...
<div class="login">
<div class="box">
<form name="input_data" action="peminjamkeluar.php"  method="post">
<table align="center" border="0" cellpadding="30" cellspacing="0" ><br>
<p><h1><center><font color= "#ededed">MASUKAN NIS PEMINJAM</p></font></h1>
<center><input type="text" placeholder="nis" minlength="10" maxlength= "10" name="nis" required><br><br><br>
